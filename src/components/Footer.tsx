                ...
                <div className="-mx-4 flex flex-wrap justify-between">
                    ...
                    <div className='flex flex-wrap justify-between'>
                        ...
                        <LinkGroup header="Quick Links">
                            <NavLink link={`/${DATA.header.navigation.home.href}`} label={`${DATA.header.navigation.home.label}`} />
                            <NavLink link={`/${DATA.header.navigation.services.href}`} label={`${DATA.header.navigation.services.label}`} />
                            <NavLink link={`/${DATA.header.navigation.methodology.href}`} label={`${DATA.header.navigation.methodology.label}`} />
                            <NavLink link={`/${DATA.header.navigation.projects.href}`} label={`${DATA.header.navigation.projects.label}`} />
                            <NavLink link={`/${DATA.header.navigation.testimonials.href}`} label={`${DATA.header.navigation.testimonials.label}`} />
                            <NavLink link={`/${DATA.header.navigation.contactUs.href}`} label={`${DATA.header.navigation.contactUs.label}`} />
                        </LinkGroup>
